class Planet {
    constructor(x, y, vx, vy) {
        ...
        // calculate agnular and radial speed
        this.radialSpeed = p5.Vector.dot(this.v, p5.Vector.mult(this.r, 1/this.r.mag()));;
        this.perpendicularSpeed = sqrt(sq(this.v.mag())-sq(this.radialSpeed));
        this.angularSpeed = this.perpendicularSpeed/this.r.mag();
    }
    ...
    adjustVelocity() {
        ...
        if ((this.E < 0 && (this.t % this.T > this.T / 2) ) || (this.E >= 0 && (this.theta < 0))) {
            anglerv = PI - anglerv;
        }
        this.v = this.r.copy();
